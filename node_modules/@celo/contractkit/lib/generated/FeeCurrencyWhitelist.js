...
exports.ABI = [
    ...
    },
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'address', name: 'token', type: 'address' }],
        name: 'NonMentoFeeCurrencyWhitelistRemoved',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'address', name: 'token', type: 'address' }],
        name: 'NonMentoFeeCurrencyWhitelisted',
        type: 'event',
    },
    {
        anonymous: false,
    ...
    },
    {
        ...
        inputs: [
            ...
            { internalType: 'uint256', name: 'indexNonMento', type: 'uint256' },
        ],
        name: 'removeNonMentoToken',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
        type: 'function',
